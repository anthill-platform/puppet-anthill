...
class anthill_static (
  ...
  String $server_name                           = $anthill_static::params::server_name,
  String $package_name                          = $anthill_static::params::package_name,
  String $package_directory                     = $anthill_static::params::package_directory,
