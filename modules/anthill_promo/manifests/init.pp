...
class anthill_promo (
  ...
  String $server_name                           = $anthill_promo::params::server_name,
  String $package_name                          = $anthill_promo::params::package_name,
  String $package_directory                     = $anthill_promo::params::package_directory,
