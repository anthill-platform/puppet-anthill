...
class anthill_environment (
  ...
  String $server_name                           = $anthill_environment::params::server_name,
  String $package_name                          = $anthill_environment::params::package_name,
  String $package_directory                     = $anthill_environment::params::package_directory,
