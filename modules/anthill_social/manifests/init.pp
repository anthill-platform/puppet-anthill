...
class anthill_social (
  ...
  String $server_name                           = $anthill_social::params::server_name,
  String $package_name                          = $anthill_social::params::package_name,
  String $package_directory                     = $anthill_social::params::package_directory,
